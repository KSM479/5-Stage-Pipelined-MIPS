...
THIS CODE WORKS PERFECTLY ON THE COMPILER - CODE::BLOCKS. TESTING OF THIS CODE ON GAUSS HAS NOT BEEN DONE WITH PRECISION. (HENCE IT MAY GENERATE SOME ERROR)
THE HELP FOR THIS CODE IS TAKEN FROM LECTURE 6 PPT & LAB 0 SOLUTION. ANY TYPE OF SIMILARITY WITH ANY OTHER CODE IS JUST A COINCIDENCE:)
*/
#include<iostream>
#include<string>
#include<vector>
